...
namespace PowerPaimon.Service
{
    public class ProcessService
    {
        ...
        public bool StartGame()
        {
            ...
            {
                MessageBox.Show(Resources.MsgInvalidPath, @"Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }

            if (IsGameRunning())
            {
                MessageBox.Show(Resources.MsgAlreadyGameLaunched, @"Error", MessageBoxButtons.OK,
            ...
            if (_config.UseHDR)
            {
                ...
                {
                    MessageBox.Show(String.Format(Resources.MsgEnableHdrFailed, e.Message), @"Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
