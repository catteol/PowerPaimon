namespace PowerPaimon
{
    partial class SettingsForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            ToolTipSettings.SetToolTip(CBAutoClose, "PowerPaimon will exit upon game closing");
            ...
            CBStartMinimized.Text = "Start Minimized (PowerPaimon)";
            ToolTipSettings.SetToolTip(CBStartMinimized, "PowerPaimon will minimized to tray on starup");
